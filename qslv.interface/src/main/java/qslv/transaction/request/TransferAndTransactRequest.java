...
public class TransferAndTransactRequest {
		...
		public String toString() {
			...
			.append(" Overdraft Reservation: ").append(transferReservation==null ? "null" : transferReservation)
			.append(", Transation Request: ").append(transactionRequest==null ? "null" : transactionRequest)
			.toString();
		}
